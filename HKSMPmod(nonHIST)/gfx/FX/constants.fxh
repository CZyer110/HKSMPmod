...
static const float CITY_LIGHTS_INTENSITY 		= 8.5;
static const float CITY_LIGHTS_BLOOM_FACTOR 	= 0.7;

static const float TERRAIN_TILE_FREQ 			= 150.0f;
...
static const float MUD_TILING 					= 0.1;
static const float MUD_NORMAL_CUTOFF 			= 10.982;
static const float MUD_STRENGHTEN 				= 0.8;
...
static const float 	ICE_CAM_MAX 				= 500.0f;
...
static const float3 SNOW_COLOR 					= float3( 0.7, 0.7, 0.7 );
static const float3 SNOW_WATER_COLOR 			= float3( 0.5, 0.6, 0.9 );
...
static const float 	ICE_NOISE_TILING  			= 0.15f;
...
static const float COLORMAP_MUD_OVERLAY_STRENGTH = 0.75f;
